...
export default function Document() {
  return (
    <Html lang="en">
      <Head>
        <title>Distant Finance Marketplace</title>
        <meta name="title" content="Bridging the Void for NFTs" />
        <meta
          name="description"
        ...
        <meta
          name="keywords"
          content="DistantFinance/ nft marketplace / distant-finance / distant finance / nfts / nft / kcc / distant/ ecosystem / finance / NFT staking / NFT bridging / Distant marketplace/ NFTs trading"
        />
